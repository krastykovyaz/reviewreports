...
class BinanceSpotWebSocket:
    """Binance Spot WebSocket client for klines streaming."""
    ...
    def __init__(
        ...
        """Initialize Binance Spot WebSocket client.
    ...
    def _build_stream_url(self) -> str:
        ...
        # For single stream: wss://stream.binance.com:9443/ws/btcusdt@kline_1m
        if len(self._subscribed_streams) == 1:
            return f"{self.base_url}/ws/{self._subscribed_streams[0]}"
        else:
            # For multiple streams: wss://stream.binance.com:9443/stream?streams=btcusdt@kline_1m/ethusdt@kline_1m
    ...
    def start(self):
        ...
        def run_websocket():
            try:
                ...
                logger.info(f"| 🚀 Starting Spot WebSocket: {stream_url}")
        ...
        self._thread.start()
        logger.info("| ✅ Spot WebSocket thread started")
    ...
    def stop(self):
        ...
        logger.info("| 🛑 Stopping Spot WebSocket...")
        self._running = False
        ...
        logger.info("| ✅ Spot WebSocket stopped")
