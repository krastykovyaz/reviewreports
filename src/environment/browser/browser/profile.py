...
from src.environment.browser.utils import _log_pretty_path, logger
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use src.environment.browser.browser.profile.ProxySettings(server, bypass, username, password)',
	)
