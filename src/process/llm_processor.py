...
from src.process.salesforce import load_salesforce
from src.utils import assemble_project_path, push_to_hub_folder
from src.config import config
from src.logger import logger
from src.process.score import compute_score
...
class LLMProcessor(AbstractProcessor):
    ...
    async def process_train_data(self, source: List[Dict[str, Any]], split: str):
        ...
        for item in source:
            ...
            download_path = assemble_project_path(os.path.join(self.workdir, name))
        ...
        if datasets:
            ...
            # save datasets
            output_path = os.path.join(self.workdir, self.repo_name)
    ...
    async def run(self, *args, **kwargs):
        ...
        push_to_hub_folder(
            ...
            folder_path=os.path.join(self.workdir, self.repo_name),
        )