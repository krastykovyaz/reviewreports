...
class GoogleSearch(Tool):
    """A tool for searching using Google search engine."""
    ...
    async def __call__(
        ...
        **kwargs
        ...
        Args:
            ...
            country (Optional[str]): The country to search in (not used by Google search function, kept for compatibility).
            lang (Optional[str]): The language to search in (not used by Google search function, kept for compatibility).
