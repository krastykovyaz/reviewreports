...
from src.tool.esg_tools.lightrag.prompts import GRAPH_FIELD_SEP, PROMPTS
import time
...
yaml_path = os.path.join(root, "prompt/rag.yaml")
...
async def _handle_entity_relation_summary(
    ...
    language = global_config["addon_params"].get(
        "language", prompt_templates["DEFAULT_LANGUAGE"]
    )
    ...
    prompt_template = prompt_templates["summarize_entity_descriptions"]
...
async def merge_nodes_and_edges(
    ...
    from src.tool.esg_tools.lightrag.kg.shared_storage import get_graph_db_lock
...
async def extract_entities(
    ...
    entity_extract_prompt = prompt_templates["entity_extraction"]
    context_base = dict(
        tuple_delimiter=PROMPTS["DEFAULT_TUPLE_DELIMITER"],
        record_delimiter=PROMPTS["DEFAULT_RECORD_DELIMITER"],
        completion_delimiter=PROMPTS["DEFAULT_COMPLETION_DELIMITER"],
    ...
    continue_prompt = prompt_templates["entity_continue_extraction"].format(**context_base)
    if_loop_prompt = prompt_templates["entity_if_loop_extraction"]
...
async def kg_query(
    ...
    if hl_keywords == [] and ll_keywords == []:
        ...
        return prompt_templates["fail_response"]
    ...
    user_prompt = (
        ...
        else prompt_templates["DEFAULT_USER_PROMPT"]
    )
    sys_prompt_temp = system_prompt if system_prompt else prompt_templates["system_prompt"]
...
async def extract_keywords_only(
    ...
    kw_prompt = prompt_templates["keywords_extraction"].format(
...
"""
    ...
    sys_prompt_temp = system_prompt if system_prompt else prompt_templates["naive_rag_response"]
    sys_prompt = sys_prompt_temp.format(
...
async def kg_query_with_keywords(
    ...
    sys_prompt_temp = prompt_templates["system_prompt"]
    sys_prompt = sys_prompt_temp.format(
        context_data=context,
        response_type=query_param.response_type,
        history=history_context,
