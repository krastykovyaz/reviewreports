...
from src.tool.esg_tools.lightrag.api import __api_version__ as api_version
from src.tool.esg_tools.lightrag import __version__ as core_version
...
from src.tool.esg_tools.lightrag.api.config import ollama_server_infos, global_args, get_env_value
