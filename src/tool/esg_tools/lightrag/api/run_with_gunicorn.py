...
from src.tool.esg_tools.lightrag.api.utils_api import display_splash_screen, check_env_file
from src.tool.esg_tools.lightrag.api.config import global_args
from src.tool.esg_tools.lightrag.utils import get_env_value
from src.tool.esg_tools.lightrag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from src.tool.esg_tools.lightrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from src.tool.esg_tools.lightrag.api.lightrag_server import get_application
