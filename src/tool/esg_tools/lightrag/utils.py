...
if TYPE_CHECKING:
    from src.tool.esg_tools.lightrag.base import BaseKVStorage
...
async def get_best_cached_response(
    ...
    if best_similarity > similarity_threshold:
        ...
        if (
            ...
            compare_prompt = prompt_templates["similarity_check"].format(
...
def check_storage_env_vars(storage_name: str) -> None:
    ...
    """
    from src.tool.esg_tools.lightrag.kg import STORAGE_ENV_REQUIREMENTS
